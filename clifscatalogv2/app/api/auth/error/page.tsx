...
export default function Error() {
  ...
  return (
    <section style={{height:'100vh', textAlign:'center',width:'100%',margin:'auto'}}>
      <h4 style={{fontSize:'2rem'}}>Something went wrong with your sign in attempt</h4>
      <p style={{fontSize:'1.5rem'}}>Please ensure you have typed the correct username & password</p>
      <br />
